...
class PdfReportGenerator:
    ...
    def upload_to_spaces_custom(self, pdf_bytes: bytes, filename: str) -> str:
    ...
    def generate_report(self, html_content: str) -> str:
        ...
        return self.upload_to_spaces_custom(pdf, filename)

def generate_and_upload_async(html_content: str, filename: str):
    """
    Genera el PDF y lo sube a DigitalOcean Spaces en segundo plano (para usar con BackgroundTasks).
    """
    gen = PdfReportGenerator()
    pdf = gen.html_to_pdf_bytes(html_content)
    gen.upload_to_spaces_custom(pdf, filename)
